...
void Buzzer_Init()
{
    ...
    // by clearing Bit 6 in the SEL0 and SEL1 registers for P4
    ...
    // by clearing Bit 6 in the OUT register for P4
    P4 -> OUT &= ~ 0x40;
...
void Buzzer_On()
{
    // Turn on the buzzer by setting Bit 6 in the OUT register for P4
    P4 -> OUT |= 0x40;
...
void Buzzer_Off()
{
    // Turn off the buzzer by clearing Bit 6 in the OUT register for P4
    P4 -> OUT &= ~0x40;
...
// When button 2 is pressed Tokyo Drift will play
void Tokyo_Drift()
{
